...
class AlbertaCovid19CaseManagerTest {
    ...
    void getAlbertaCovid19CaseList() {
        assertEquals(436_495, caseManager.getAlbertaCovid19CaseDataList().size());
    }
    ...
    void findById() {
        Optional<AlbertaCovid19CaseData> optionalResult = caseManager.findById(1);
        assertTrue(optionalResult.isPresent());
        AlbertaCovid19CaseData result = optionalResult.get();
