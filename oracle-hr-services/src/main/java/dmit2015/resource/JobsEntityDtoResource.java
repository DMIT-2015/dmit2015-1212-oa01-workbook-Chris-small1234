...
public class JobsEntityDtoResource {
    ...
    public Response updateJobsEntity(@PathParam("id") String id, JobsEntityDto dto) {
        ...
        JobsEntity updatedJobsEntity = JobsEntityMapper.INSTANCE.toEntity(dto);
        ...
        //existingJobsEntity.setVersion(updatedJobsEntity.getVersion());
