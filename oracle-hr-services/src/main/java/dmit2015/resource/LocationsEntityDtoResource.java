...
public class LocationsEntityDtoResource {
    ...
    @Path("{id}")
    @GET    // This method only accepts HTTP GET requests.
    public Response findLocationsEntityById(@PathParam("id") Short locationsEntityId) {
    ...
    public Response updateLocationsEntity(@PathParam("id") Short id, LocationsEntityDto dto) {
        if (!id.equals(dto.getLocationId())) {
        ...
        LocationsEntity updatedLocationsEntity = LocationsEntityMapper.INSTANCE.toEntity(dto);
        ...
        //existingLocationsEntity.setVersion(updatedLocationsEntity.getVersion());
    ...
    @Path("{id}")    // This method accepts a path parameter and gives it a name of id
    public Response delete(@PathParam("id") Short locationsEntityId) {

        LocationsEntity existingLocationsEntity = _locationsEntityRepository
                .findOptional(locationsEntityId)
                .orElseThrow(NotFoundException::new);
